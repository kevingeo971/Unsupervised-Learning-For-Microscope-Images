...
class Network(nn.Module):
    ...
    def __init__  (self):
        ...
        self.e_conv_2 = nn.Sequential(
            nn.Conv2d(bias=False,in_channels=64, out_channels=128, kernel_size=(4, 4), stride=(2, 2)),
            nn.ReLU(),
            nn.BatchNorm2d(128)
        ...
        self.e_conv_3 = nn.Sequential(
            nn.Conv2d(bias=False,in_channels=128, out_channels=32, kernel_size=(5, 5), stride=(1, 1)),
            nn.ReLU(),
            nn.BatchNorm2d(32),            
        )
        ...
        self.d_up_conv_0 = nn.Sequential(
            ...
            nn.ZeroPad2d((1, 1, 1, 1)),
            nn.ConvTranspose2d(in_channels=32, out_channels=32, kernel_size=(3, 3), stride=(1, 1)),
            nn.ReLU(),
            nn.BatchNorm2d(32),            
        )
        ...
        self.d_up_conv_1 = nn.Sequential(
            ...
            nn.ZeroPad2d((1, 1, 1, 1)),
            nn.ConvTranspose2d(in_channels=64, out_channels=128, kernel_size=(5, 5), stride=(1, 1)),
            nn.ReLU(),
            nn.BatchNorm2d(128)
        ...
        self.d_up_conv_2 = nn.Sequential(
            ...
            # nn.ZeroPad2d((1,0,0,0)),
            nn.ConvTranspose2d(in_channels=32, out_channels=32, kernel_size=(4, 4), stride=(2, 2)),
            nn.ReLU(),
            nn.BatchNorm2d(32)            
        )
        ...
        self.d_up_conv_3 = nn.Sequential(
            nn.ZeroPad2d((1,1,1,1)),
            nn.ConvTranspose2d(bias=False,in_channels=32, out_channels=16, kernel_size=(4, 4), stride=(2, 2)),
            nn.ReLU(),
            nn.BatchNorm2d(16),            
    ...
    def forward(self, x, encode=False):
        ...
        eblock4 = self.e_block_3(eblock3)
        eblock5 = self.e_block_3(eblock4)
        ec3 = self.e_conv_3(eblock5) 
        ec4 = self.e_conv_4(ec3)
        self.sh = ec4.shape
        self.encoded = self.lin_in(ec4.view(len(ec4), -1))
        
        self.pass_on=(eblock1,eblock2,eblock3,eblock4,eblock5,ec3,ec4,ec2)
    ...
    def decode(self, encoded):
        ...
        eblock1,eblock2,eblock3,eblock4,eblock5,ec3,ec4,ec2 = self.pass_on  

        y = encoded 
        y = self.lin_out( y )
        y = y.view(self.sh)
        uc0 = self.d_up_conv_0(y) + ec3
        uc1 = self.d_up_conv_1(uc0) + eblock1
        dblock1 = self.d_block_1(uc1) + eblock2
        dblock2 = self.d_block_2(dblock1) + eblock3
        dblock3 = self.d_block_3(dblock2) + eblock4
        dblock4 = self.d_block_3(dblock3) + eblock5
        dblock5 = self.d_block_3(dblock4) + ec2
