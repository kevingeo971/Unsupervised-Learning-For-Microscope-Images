...
def train(epochs):
    ...
    cluster_lables = KMeans(n_clusters=50, random_state=0).fit(feat).labels_
    ...
    print("Deep Cluster Loss : ",op_train_loss) #"Accuracy : ", train_total_accuracy)
