...
rev_train_left = X_train[:,:mid,:,:].copy()
rev_train_right = X_train[:,mid:,:,:].copy()

rev_val_left = X_val[:,:mid,:,:].copy()
rev_val_right = X_val[:,mid:,:,:].copy()

mim.imsave("Outputs/test.png",rev_train_left[0])
mim.imsave("Outputs/test_flip.png",rev_train_right[0])
mim.imsave()



print("Rev Train: ",rev_train_left.shape, rev_train_right.shape)
Data_train = CancerData(rev_train_left, rev_train_right)
Data_val = CancerData(rev_val_left, rev_val_right)
